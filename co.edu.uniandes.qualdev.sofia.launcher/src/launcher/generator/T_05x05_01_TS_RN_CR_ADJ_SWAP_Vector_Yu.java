...
public class T_05x05_01_TS_RN_CR_ADJ_SWAP_Vector_Yu{
	...
	public T_05x05_01_TS_RN_CR_ADJ_SWAP_Vector_Yu(String pAlgorithmFile, String pProblemFile, String pCurrentBks, String pInstanceType, String pInstanceName) {
			super();
	...
	public static ArrayList<String[]> datos() {
		...
		String[] file1= {
			"./data/Om-TT/Algorithm/Vector/TS_RN_CR_ADJ_SWAP.properties","./data/Om-TT/05x05/05x05_01.properties", "gamma.cmax.bks.om.tt", "Yu","05x05_01"};
		datos.add(file1);
			return datos;
	}
	@Before
	...
	public void tearDown(){
		ChartPrinter.getInstance().printGlobalResultsHTML("./results/Om_TT/T_05x05_01_TS_RN_CR_ADJ_SWAP_Vector_Yu_consolidated.html");
	}
	public static void main(String[] args) {
 		JUnitCore.main("launcher.generator.T_05x05_01_TS_RN_CR_ADJ_SWAP_Vector_Yu");  
	}
}
