...
public class T_04x04_01_TS_RN_CR_ADJ_SWAP_Vector_Yu{
	...
	public T_04x04_01_TS_RN_CR_ADJ_SWAP_Vector_Yu(String pAlgorithmFile, String pProblemFile, String pCurrentBks, String pInstanceType, String pInstanceName) {
			super();
	...
	public static ArrayList<String[]> datos() {
		...
		String[] file1= {
			"./data/Om-TT/Algorithm/Vector/TS_RN_CR_ADJ_SWAP.properties","./data/Om-TT/04x04/04x04_01.properties", "gamma.cmax.bks.om.tt", "Yu","04x04_01"};
		datos.add(file1);
			return datos;
	}
	@Before
	...
	public void tearDown(){
		ChartPrinter.getInstance().printGlobalResultsHTML("./results/Om_TT/T_04x04_01_TS_RN_CR_ADJ_SWAP_Vector_Yu_consolidated.html");
	}
	public static void main(String[] args) {
 		JUnitCore.main("launcher.generator.T_04x04_01_TS_RN_CR_ADJ_SWAP_Vector_Yu");  
	}
}
