...
public class LRPTNonDelay implements IInitialSolBuilder{
	...
	public IStructure createInitialSolution(ArrayList<String> problemFiles, ArrayList<BetaVO> betas, 
		...
		for (int i = 0; i < operations.size(); i++) {
			...
			// Esta lista me sirve para saber cuales son las estaciones que el job actual (identificado con i) ya visit�. De esta manera 
			// se cumple la restricci�n de no visitar m�s de una m�quina en la misma estaci�n. 
		...
		while(index < operationsAmount){
			...
			// Quita todas las operaciones en el vector con el mismo par job estaci�n para descartar las operaciones repetidas de un job en la misma estaci�n. 
			// Programa la operaci�n seleccionada
