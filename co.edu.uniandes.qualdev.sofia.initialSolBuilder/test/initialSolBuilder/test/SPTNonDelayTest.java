...
public class SPTNonDelayTest {
	...
	public void testLPTNonDelay04x04x02_1() throws Exception{
		...
		// Validando el tama�o de la lista
		Assert.assertEquals("El vector deberia tener un tama�o de 16", vector.getOperations().size(), 16);
		...
		Assert.assertEquals("La segunda posicion deberia ser las <3,3,7>",vector.getOperations().get(1), new Operation(new OperationIndexVO(0, 3, 3, 7)));
		Assert.assertEquals("La segunda posicion deberia comenzar en 2 y terminar en 12",vector.getOperations().get(1).getInitialTime()==2 && vector.getOperations().get(1).getFinalTime()==12, true );
		
		Assert.assertEquals("La tercera posicion deberia ser las <0,1,2>",vector.getOperations().get(2), new Operation(new OperationIndexVO(0, 0, 1, 2)));
		Assert.assertEquals("La tercera posicion deberia comenzar en 5 y terminar en 14",vector.getOperations().get(2).getInitialTime()==5 && vector.getOperations().get(2).getFinalTime()==13, true );
		
		Assert.assertEquals("La cuarta posicion deberia ser las <2,1,3>",vector.getOperations().get(3), new Operation(new OperationIndexVO(0, 2, 1, 3)));
		Assert.assertEquals("La cuarta posicion deberia comenzar en 5 y terminar en 13",vector.getOperations().get(3).getInitialTime()==5 && vector.getOperations().get(3).getFinalTime()==14, true );
		...
		Assert.assertEquals("La sexta posicion deberia ser las <0,0,0>",vector.getOperations().get(5), new Operation(new OperationIndexVO(0, 0, 0, 0)));
		Assert.assertEquals("La sexta posicion deberia comenzar en 15 y terminar en 25",vector.getOperations().get(5).getInitialTime()==15 && vector.getOperations().get(5).getFinalTime()==25, true );
		
		Assert.assertEquals("La septima posicion deberia ser las <3,2,5>",vector.getOperations().get(6), new Operation(new OperationIndexVO(0, 3, 2, 5)));
		...
		Assert.assertEquals("La octava posicion deberia ser las <2,0,1>",vector.getOperations().get(7), new Operation(new OperationIndexVO(0, 2, 0, 1)));
		Assert.assertEquals("La octava posicion deberia comenzar en 16 y terminar en 26",vector.getOperations().get(7).getInitialTime()==16 && vector.getOperations().get(7).getFinalTime()==26, true );
		
		Assert.assertEquals("La novena posicion deberia ser las <1,0,0>",vector.getOperations().get(8), new Operation(new OperationIndexVO(0, 1, 0, 0)));
		Assert.assertEquals("La novena posicion deberia comenzar en 27 y terminar en 37",vector.getOperations().get(8).getInitialTime()==28 && vector.getOperations().get(8).getFinalTime()==37, true );
		
		Assert.assertEquals("La decima posicion deberia ser las <0,2,4>",vector.getOperations().get(9), new Operation(new OperationIndexVO(0, 0, 2, 4)));
		Assert.assertEquals("La decima posicion deberia comenzar en 28 y terminar en 39",vector.getOperations().get(9).getInitialTime()==28 && vector.getOperations().get(9).getFinalTime()==39, true );
		
		Assert.assertEquals("La undecima posicion deberia ser las <3,0,1>",vector.getOperations().get(10), new Operation(new OperationIndexVO(0, 3, 0, 1)));
		Assert.assertEquals("La undecima posicion deberia comenzar en 28 y terminar en 42",vector.getOperations().get(10).getInitialTime()==28 && vector.getOperations().get(10).getFinalTime()==42, true );
		
		Assert.assertEquals("La doceava posicion deberia ser las <2,2,5>",vector.getOperations().get(11), new Operation(new OperationIndexVO(0, 2, 2, 5)));
		Assert.assertEquals("La doceava posicion deberia comenzar en 29 y terminar en 38",vector.getOperations().get(11).getInitialTime()==29 && vector.getOperations().get(11).getFinalTime()==38, true );
	}
}