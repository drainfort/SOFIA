 ...
 */
public class AFSSPTNonDelay implements IInitialSolBuilder{
	...
	public IStructure createInitialSolution(ArrayList<String> problemFiles,
		...
		return VectorFactory.createNewInstance("structure.factory.impl.VectorFactory").createSolutionStructure(AFSInitialSolutionCreator.getInstance().createInitialSolution("SPT", TFile, TTFile), problemFiles, betas);
	}
