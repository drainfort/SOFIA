...
public class AFSSPTNonDelay implements IInitialSolBuilder{
	...
	public IStructure createInitialSolution(ArrayList<String> problemFiles,
		...
		return VectorFactory.createNewInstance(structureFactory).createSolutionStructure(AFSInitialSolutionCreator.getInstance().createInitialSolution("SPT", TFile, TTFile), problemFiles, betas);
	}
