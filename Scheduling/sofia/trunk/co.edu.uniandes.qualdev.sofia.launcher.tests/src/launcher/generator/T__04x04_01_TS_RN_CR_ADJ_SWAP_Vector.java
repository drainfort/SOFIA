...
public class T__04x04_01_TS_RN_CR_ADJ_SWAP_Vector{
	private Launcher launcher;
	private String algorithmFile;
	private String problemFile;
	private String resultsFile;
	private String instanceName;
	public T__04x04_01_TS_RN_CR_ADJ_SWAP_Vector(String pAlgorithmFile, String pProblemFile, String pResultsFile, String pInstanceName) {
			super();
	...
	public void tearDown(){
		ChartPrinter.getInstance().printGlobalResultsHTML("./results/Om_TT/T__04x04_01_TS_RN_CR_ADJ_SWAP_Vector_consolidated.html");
	}
	public static void main(String[] args) {
 		JUnitCore.main("launcher.generator.T__04x04_01_TS_RN_CR_ADJ_SWAP_Vector");  
	}
}
