...
public class Test_N6_ShiftBlockAdjOnEnds {
	// -----------------------------------------------
	// Attributes
	// -----------------------------------------------
	
	private ShiftBlockAdjOnEnds neighborCalulator;
	...
	public void setUpScenario1() throws Exception {
		neighborCalulator = new ShiftBlockAdjOnEnds();
