...
public class Test_DecodeSequencial {
	...
	public void setUpScenario() throws Exception {
		...
		vectorScenario = (Vector) VectorFactory.createNewInstance(
				...
				.createSolutionStructure(problemFiles, betas, new SequencialDecoding());
	...
	@Test
	public void testSequencialDecodingOperationsOrder() throws InterruptedException {
	...
	@Test
	public void testSequencialDecodingSchedule(){
		// Calling the decoding method
		vectorScenario.decodeSolution();
