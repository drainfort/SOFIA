...
import structure.impl.decoding.CandidateActiveDecoding;
import common.types.BetaVO;
import common.types.OperationIndexVO;

public class Test_DecodeCandidateActive {
	...
	public void setUpScenario() throws Exception {
		...
		vectorScenario = (Vector) VectorFactory.createNewInstance(
				...
				.createSolutionStructure(problemFiles, betas, new CandidateActiveDecoding());
