...
public class TrajectoryBasedAlgorithm extends SchedulingAlgorithm {
	...
	public TrajectoryBasedAlgorithm(Properties algorithmConfiguration, Properties problemConfiguration) throws InstantiationException, IllegalAccessException, ClassNotFoundException, Exception{
	...
	public ExecutionResults execute(String resultsFile, String instanceName) throws Exception {
